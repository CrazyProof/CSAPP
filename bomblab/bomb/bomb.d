...
00000000004010f4 <phase_6>:
  ...
  401103:	48 89 e6             	mov    %rsp,%rsi      /* %rdi是输入的字符串首字母地址，%rsi是从哪里开始存
  401106:	e8 51 03 00 00       	callq  40145c <read_six_numbers>
  40110b:	49 89 e6             	mov    %rsp,%r14
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d
  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax   /* 这里的%eax存的是输入的第一个数字
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax        /* 所有数字小于等于6即可
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	callq  40143a <explode_bomb>
  401128:	41 83 c4 01          	add    $0x1,%r12d
  40112c:	41 83 fc 06          	cmp    $0x6,%r12d       /* 似乎永远都不可能等于6
  401130:	74 21                	je     401153 <phase_6+0x5f>      /* 必须从这个口出
  401132:	44 89 e3             	mov    %r12d,%ebx
  401135:	48 63 c3             	movslq %ebx,%rax        /* sign-extend，符号位扩展
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax   /* %eax中存的是第二个数
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)       /* 将第二个数与第一个数作比较
  40113e:	75 05                	jne    401145 <phase_6+0x51>    /* 不一样即可
  401140:	e8 f5 02 00 00       	callq  40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx      /* 跳转到这里，给%ebx加1
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>      /* 循环6次，六个数字都不相同即可
  40114d:	49 83 c5 04          	add    $0x4,%r13                  /* 指向第二个数字的位置
  401151:	eb c1                	jmp    401114 <phase_6+0x20>      /* 循环6次让每个数字都小于6
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi
  401158:	4c 89 f0             	mov    %r14,%rax                  /* %rax指向栈顶
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx

  401160:	89 ca                	mov    %ecx,%edx
  401162:	2b 10                	sub    (%rax),%edx                /* 7减去第一个数
  401164:	89 10                	mov    %edx,(%rax)                /* 第一个数变为6
  401166:	48 83 c0 04          	add    $0x4,%rax
  40116a:	48 39 f0             	cmp    %rsi,%rax
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>      /* 这里又是循环，将六个数全部替换为7-i
  40116f:	be 00 00 00 00       	mov    $0x0,%esi
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>

  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx             /* 每次将0x6032d0加上8位置的数赋值给%rdx,但是这里存的数就是+8位的地址
  40117a:	83 c0 01             	add    $0x1,%eax                  /* 
  40117d:	39 c8                	cmp    %ecx,%eax                  /* 将第一个数和2比较
  40117f:	75 f5                	jne    401176 <phase_6+0x82>      /* 这里需要循环i-1次，使得上面的rdx也+16*(i-1)
  401181:	eb 05                	jmp    401188 <phase_6+0x94>
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx

  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)     /* 在%rsp+36的位置
  ...
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>        /* 遇到1就跳转，并重置数字为0x6032d0
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>

  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax      /* %rax指向第二个数
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi
  4011ba:	48 89 d9             	mov    %rbx,%rcx            /* %rbx, %rcx存的是构造的第一个数
  4011bd:	48 8b 10             	mov    (%rax),%rdx          /* %rdx存的是构造的第二个数
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)       /* 第一个数加8的地址存第二个数
  4011c4:	48 83 c0 08          	add    $0x8,%rax            /* %rax指向第三个数
  4011c8:	48 39 f0             	cmp    %rsi,%rax
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>  /* 将每一个数都存在前一个数+8作为地址的位置上
  4011cd:	48 89 d1             	mov    %rdx,%rcx
  4011d0:	eb eb                	jmp    4011bd <phase_6+0xc9>
  4011d2:	48 c7 42 08 00 00 00 	movq   $0x0,0x8(%rdx)        /* %rdx存的是构造的第六个数
  4011d9:	00 
  4011da:	bd 05 00 00 00       	mov    $0x5,%ebp
  4011df:	48 8b 43 08          	mov    0x8(%rbx),%rax        /* 这里的%rbx还是存的第一个数
  4011e3:	8b 00                	mov    (%rax),%eax           /* %rax指向第六个数之后，让他自己存该地址的数
  4011e5:	39 03                	cmp    %eax,(%rbx)           /* 第一个数指向的数大于等于第七个数指向的数
  4011e7:	7d 05                	jge    4011ee <phase_6+0xfa>
  4011e9:	e8 4c 02 00 00       	callq  40143a <explode_bomb>
  4011ee:	48 8b 5b 08          	mov    0x8(%rbx),%rbx        /* 第一个数加8指向的数
